...
import traceback
import os
from app.services.Aplicacao3.PromptTreinoStrategy import PromptTreinoStrategy
from app.services.Framework.ChatService import ChatService


chat3_bp = Blueprint("chat3", __name__, url_prefix="/chat3")
...
def build_chat_service(db):
    ...
    prompt_strategy = PromptTreinoStrategy(db)
...
@chat3_bp.route("/historico/<int:user_id>", methods=["GET"])
...
@chat3_bp.route("/historico/<int:user_id>", methods=["DELETE"])
