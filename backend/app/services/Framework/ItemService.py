...
class ItemService:
    ...
    def adicionar(self, ator_id: int, dados: Dict[str, Any], implementacao: Type[ItemTemplate]) -> Any:
        try:
    ...
    def atualizar(self, item_id: int, dados: Dict[str, Any], implementacao: Type[ItemTemplate]) -> Any:
        try:
            implementacao_instancia = implementacao(self.db)
    ...
    def remover(self, item_id: int, implementacao: Type[ItemTemplate]) -> None:
        try:
            implementacao_instancia = implementacao(self.db)
    ...
    def buscar_por_ator(self, ator_id: int, implementacao: Type[ItemTemplate]) -> Any:
        try:
            implementacao_instancia = implementacao(self.db)
