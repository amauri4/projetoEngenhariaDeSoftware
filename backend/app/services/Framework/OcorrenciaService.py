...
class ServicoDeOcorrencia:
    ...
    def gerar_proximas(self, item_id: int, periodo_em_dias: int, implementacao: Type[OcorrenciaTemplate]) -> List[Any]:
        try:
    ...
    def criar_unica(self, item_id: int, data_str: str, status: bool, implementacao: Type[OcorrenciaTemplate]) -> Any:
        try:
            implementacao_instancia = implementacao(self.db)
    ...
    def atualizar_status(self, ocorrencia_id: int, novo_status: bool, implementacao: Type[OcorrenciaTemplate]) -> Any:
        try:
            implementacao_instancia = implementacao(self.db)
    ...
    def remover(self, ocorrencia_id: int, implementacao: Type[OcorrenciaTemplate]) -> None:
        try:
            implementacao_instancia = implementacao(self.db)
    ...
    def buscar_por_ator(self, ator_id: int, implementacao: Type[OcorrenciaTemplate]) -> List[Any]:
        try:
            implementacao_instancia = implementacao(self.db)
    ...
    def buscar_concluidas_por_ator(self, ator_id: int, implementacao: Type[OcorrenciaTemplate]) -> List[Any]:
        try:
            implementacao_instancia = implementacao(self.db)
    ...
    def buscar_por_data(self, ator_id: int, data_inicio: Optional[str], data_fim: Optional[str], implementacao: Type[OcorrenciaTemplate]) -> List[Any]:
        try:
            implementacao_instancia = implementacao(self.db)
    ...
    def buscar_por_data_especifica(self, ator_id: int, data_especifica: str, implementacao: Type[OcorrenciaTemplate]) -> List[Any]:
        try:
            implementacao_instancia = implementacao(self.db)
